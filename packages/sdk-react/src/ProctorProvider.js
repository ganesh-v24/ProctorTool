...
import { NovelProctor } from '../../sdk-core/src';
const ProctorContext = createContext(undefined);
/**
...
export const ProctorProvider = ({ children, options, }) => {
    ...
    return (_jsx(ProctorContext.Provider, { value: { proctor, ready }, children: children }));
};
/**
